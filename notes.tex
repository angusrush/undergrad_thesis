...
\begin{proof}
  ...
  \begin{equation*}
    \begin{tikzcd}[row sep=large, column sep=large]
      A_{1}
      \arrow[r, "\rho_{A_{1}}^{-1}"]
      \arrow[rrdd, swap, "f_{1}"]
      & A_{1} \otimes 1
      \arrow[r, "\mathrm{id}_{A_{1}} \otimes e_{2}"]
      \arrow[rd, swap, "f_{1} \otimes e_{R}"]
      & A_{1} \otimes A_{2}
      \arrow[d, "f_{1} \otimes f_{2}"]
      & 1 \otimes A_{2}
      \arrow[l, swap, "e_{1} \otimes \mathrm{id}_{A_{2}}"]
      \arrow[ld, "e_{R} \otimes f_{2}"]
      & A_{2}
      \arrow[l, swap, "\lambda_{A_{1}}^{-1}"]
      \arrow[lldd, "f_{2}"]
      \\
      & & R \otimes R
      \arrow[d, "m_{R}"]
    ...
    \end{tikzcd}
  \end{equation*}
  The map $f$ is given by $m_{R} \circ (f_{1} \otimes f_{2})$, where $m_{R}$ is the multiplication on $R$. It is unique because 
\end{proof}
...
\begin{definition}[comodule object]
  ...
  Let $\mathscr{A}$ be a tensor category, let $A$ be a commutative Hopf algebra over $k$ modelled on $\mathscr{A}$ (\hyperref[def:commutativehopfalgebraoverafieldmodelledonatensorcategory]{Definition \ref*{def:commutativehopfalgebraoverafieldmodelledonatensorcategory}}). 
  
  An \defn{$A$-comodule} is a pair $(N, \rho)$, where $N \in \Obj(\mathsf{CMon}(\mathscr{A}))$ and
  \begin{equation*}
    \rho\colon N \to A \otimes N
  \end{equation*}
  is a module morphism which makes the following diagrams commute.
  \begin{equation*}
    \begin{tikzcd}
      V
      \arrow[r, "\rho"]
...
\begin{definition}[comodule homomorphism]
  ...
  Let $N$ and $N'$ be $A$-comodule objects. A \defn{$A$-comodule homomorphism} $\varphi\colon N \to N'$ is a homomorphism of commutative monoids which makes the following diagram commute.
\end{definition}
...
\begin{definition}[tensor product of comodules]
  ...
  Let $A$ be a commutative Hopf algebra (\hyperref[def:commutativehopfalgebra]{Definition \ref*{def:commutativehopfalgebra}}) over $k$, and let $N$ and $N'$ be $A$-comodules (\hyperref[def:comoduleobject]{Definition \ref*{def:comoduleobject}}).

  The \defn{comodule tensor product} is the object $N \otimes N'$ together with the coaction $N \otimes N' \to A \otimes N \otimes N'$ given by the composition
  \begin{equation*}
    \begin{tikzcd}
      N \otimes N'
      \arrow[r, "\rho \otimes \rho'"]
      & A \otimes N \otimes A \otimes N'
      \arrow[r, "\gamma"]
      & A \otimes A \otimes N \otimes N'
      \arrow[r, "\nabla"]
      & A \otimes N \otimes N'
    \end{tikzcd}.
  \end{equation*}
