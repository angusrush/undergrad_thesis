...
Central to Deligne's theorem is the idea of an affine algebraic super-group. These are simply defined as affine super schemes which are also groups. As usual, the way to formalize this is with internal objects.
...
It seems to me that, probably, it would suffice to study the category theory of Hopf algebras. However, in the name of full generality, the nLab article \cite{nlab-deligne-theorem} does everything with \emph{Hopf algebroids}, and in for a penny, in for a pound.
...
It turns out, due to a theorem of Bargmann
...
\begin{enumerate}
  ...
  \item Various questions about functional analysis: category of unitary representations (defined in a sort of an odd way) might be a tensor category?
\end{enumerate}
