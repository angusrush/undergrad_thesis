...
\begin{definition}[curried hom functor]
  ...
  \begin{itemize}
    ...
    \item a functor $h_{A}\colon \mathsf{C}^{\text{op}} \rightsquigarrow \mathsf{Set}$ which maps
      \begin{itemize}
...
\begin{example}
  ...
  The exponential is a little bit more complicated: it allows us to trade between a morphism
  \begin{equation*}
    X \times A \to B
  \end{equation*}
  and a morphism 
  \begin{equation*}
    X \to B^{A}.
  \end{equation*}
  That is to say, we have a bijection between two functors $\mathsf{C}^{\text{op}} \rightsquigarrow \mathsf{Set}$
  \begin{equation*}
...
\begin{theorem}[Yoneda lemma]
  Let $\mathcal{F}$ be a functor from $\mathsf{C}$ to $\mathsf{Set}$. Let $A \in \Obj(\mathsf{C})$. Then there is a set-isomorphism (i.e. a bijection) between the set $\Nat(h^{A}, \mathcal{F})$ of natural transformations $h^{A} \Rightarrow \mathcal{F}$ and the set $\mathcal{F}(A)$. Furthermore, this isomorphism is natural in $A$.
\end{theorem}
\begin{proof}
  ...
  \begin{equation*}
    ...
    \end{tikzcd}
  \end{equation*}
  The natural transformation $\Phi\colon h^{A} \Rightarrow \mathcal{F}$ has a component $\Phi_{A}\colon \Hom_{\mathsf{C}}(A, A) \to \mathcal{F}(A)$, and $\Phi_{A}$ has to send the identity transformation $1_{A}$ \emph{somewhere}. It can send it to any element of $\mathcal{F}(A)$; let's call $\Phi_{A}(1_{A}) = a$.
  ...
  Almost. We still have to show that the bijection we constructed above is natural. To that end, let $f\colon A \to A'$. We need to show that the following square commutes.
\end{proof}
...
\begin{definition}[Yoneda embedding]
  ...
  \begin{equation*}
    \mathcal{Y}\colon \mathsf{C}^{\text{op}} \rightsquigarrow [\mathsf{C}, \mathsf{Set}], \qquad A \mapsto h^{A}.
  \end{equation*}
...
\begin{proof}
  ...
  \begin{equation*}
    \mathcal{Y}_{A, B}\colon \Hom_{\mathsf{C}}(B, A) \to \Hom_{[\mathsf{C}, \mathsf{Set}]}(h^{A}, h^{B})
  \end{equation*}
  is a bijection.
  ...
  \begin{equation*}
    h^{B}(A) = \Hom_{\mathsf{C}}(B, A).
  \end{equation*}

  But $\Nat(h^{A}, h^{B})$ is nothing else but $\Hom_{[\mathsf{C}, \mathsf{Set}]}(h^{A}, h^{B})$, so we are done.
\end{proof}
...
\begin{definition}[contravariant Yoneda embedding]
  ...
  \begin{equation*}
    \mathsf{C} \rightsquigarrow [\mathsf{C}^{\text{op}}, \mathsf{Set}];\qquad A \mapsto h_{A}.
  \end{equation*}
\end{definition}
\begin{theorem}
