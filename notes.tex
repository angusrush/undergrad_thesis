...
\begin{titlepage}
  ...
  \HRule \\[0.4cm]
  { \huge \bfseries Deligne's Theorem on Tensor Categories}\\[0.4cm] % Title of your document
  { \Large \bfseries And its Implications for Quantum Mechanics}\\[0.4cm] % Subtitle of your document
  \HRule \\[1.5cm]
...
The existence of such a functor can tell us quite a lot about the structure of $\mathsf{QSys}(\mathcal{S})$. Since $\mathcal{J}$ is essentially surjective and fully faithful, it is `bijective up to isomorphism'. That is, every object in $\mathsf{QSys}(\mathcal{S})$ is the image of some representation of $G$.
