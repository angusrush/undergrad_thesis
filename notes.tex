...
We use Deligne's \cite{deligne-categories-tensorielle} definition of a tensor category.

For our purposes, the algebraically closed field $k$ will be taken to be the field of complex numbers $\C$. The definition of a $k$-tensor category is long and complicated. Roughly speaking, it is a category in which you can multiply objects in a tensor-y sort of way.
\begin{itemize}
...
Deligne's theorem tells us that any tensor category which satisfies the condition of subexponential growth behaves like the category of representations of an algebraic super-group.
