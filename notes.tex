...
\begin{note}
  ...
  So far, this is all okay; however, contrary to what is claimed in \cite{nlab-deligne-theorem}, $\mathsf{Rep}_{\mathsf{Hilb}_{\C}}(\bar{G})$ cannot be made into a tensor category because it is not abelian. More specifically, 
\end{note}
