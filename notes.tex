  ...
  \begin{enumerate}
    ...
    \item The tensor product on $\mathsf{A}$ extends to $\mathsf{Ind}(\mathsf{A})$ via
      \begin{align*}
        ...
        &\simeq \lim_{i,j} (X_{i} \otimes Y_{j}).
      \end{align*}
...
The eagle-eyed reader has probably noticed that not all fundamental particles fit into this classification scheme: both quarks and neutrinos can exist in a superposition of states of different mass, so they cannot be classified by mass-squared. This is because quarks and neutrinos are not irreducible representations of the Poincar\'{e} group, but rather of the product of the full symmetry group:
\begin{equation*}
  \overbrace{\mathrm{ISO}(1, 3)}^{\text{Poincar\'{e}}} \times \overbrace{\mathrm{SU}(3) \times \mathrm{SU}(2) \times \mathrm{U}(1)}^{\text{gauge}} \times \mathrm{U}(3),
\end{equation*}
where the final $\mathrm{U}(3)$ factor interchanges the three generations of particles which couple to the weak interaction.

Thus it is not exactly correct to say that fundamental particles are exactly irreducible representations of the symmetry group of spacetime: the more correct statement is that particles are irreducible representations of the total symmetry group. If all sectors except 

\section{Wigner classification on more general spacetimes}
Let us consider the case in which we generalize the symmetry group of spacetime to a general (algebraic) super group.

The basic idea of the previous section is unchanged. If our quantum theory has a symmetry given by some algebraic super group $G$, the Hilbert space must admit a ray representation of $G$, and particles correspond to irreducible representations of $G$.
...
Deligne's theorem tells us, roughly, that every tensor category is the category of representations of some (algebraic) super-group.

Recalling Wigner, particles are irreducible representations of the (covering group of) the symmetry group of 

Deligne's theorem provides a justification for the belief in supersymmetry which has fewer constraints and assumptions than the justifications listed in the
...
\begin{enumerate}
  ...
  \item Irreducible means irreducible w.r.t. direct sums. We're talking about irreducible w.r.t. tensor products. What gives?
    ...
    \emph{Possible partial answer: It only really makes sense to talk about particles at all when they are approximately free since e.g. the number operator doesn't commute with time evolution. When particles are free,}
\end{enumerate}
