...
Let $X$ be a smooth manifold, and let $\pi\colon V \to X$ be a vector bundle over $X$. The set $\Gamma(V)$ of sections of $X$ naturally has the structure of a $C^{\infty}(M)$-module. Furthermore, any vector bundle morphism $(\pi\colon X \to V) \to (\pi'\colon V' \to X')$ induces an algebra homomorphism $\Gamma_{X'}(V')$ via the pullback.
