...
\begin{example}
  A monoid internal to $\mathsf{Vect}_{k}$ is a unitary, associative $k$-algebra. Let us see that this matches up with \hyperref[def:algebraoverafield]{Definition \ref*{def:algebraoverafield}}.
  ...
  The product is a bilinear map on $A \times A$; by the universal property for the tensor product (\hyperref[eg:universalpropertyoftensorproduct]{Example \ref*{eg:universalpropertyoftensorproduct}}) 
\end{example}
