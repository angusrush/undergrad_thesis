...
\subsection{The category \texorpdfstring{$\mathsf{SVect}_{k}$}{Lg}}
...
\section{The category of \texorpdfstring{$\mathcal{S}$}{Lg}-symmetric quantum systems} \label{sec:categoryofsymmetricquantumsystems}
